...
| --------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `headers` | Map&lt;string, string&gt; | Headers to be added to the either the request or response. Supports [cel expressions](#templating-syntax) for variable interopolation in header values. |
