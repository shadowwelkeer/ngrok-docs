...
| --------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `from`    | string | A regular expression string to match inside of the URL. Supports [cel expressions](#templating-syntax) for variable interopolation outside of regex.       |
| `to`      | string | A regular expression string to replace the `from` match with. Supports [cel expressions](#templating-syntax) for variable interopolation outside of regex. |
